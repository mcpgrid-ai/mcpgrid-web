...
export const getDeleteDocumentsBatchMutationOptions = <
...
export type DeleteDocumentsBatchMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteDocumentsBatch>>
>;
 ...
 * @summary Delete documents by batch
 */
export const useDeleteDocumentsBatch = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getDocuments = (
  ...
  return customInstance<PaginationViewValue>(
    { url: `/indexes/${indexUid}/documents`, method: 'GET', params, signal },
    options,
  );
};
...
export const useGetDocumentsInfiniteQueryOptions = <
...
>(
  ...
  const queryKey =
    queryOptions?.queryKey ?? getGetDocumentsQueryKey(indexUid, params);
...
export type GetDocumentsInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof getDocuments>>
>;
...
export function useGetDocumentsInfinite<
  TData = Awaited<ReturnType<typeof getDocuments>>,
  TError = ResponseError,
>(
  indexUid: string,
  ...
  const queryOptions = useGetDocumentsInfiniteQueryOptions(
    indexUid,
    params,
    options,
  );
...
export const useGetDocumentsQueryOptions = <
  TData = Awaited<ReturnType<typeof getDocuments>>,
  TError = ResponseError,
>(
  indexUid: string,
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getDocuments>>> = ({
    signal,
  }) => getDocuments(indexUid, params, requestOptions, signal);
...
export const getUpdateDocumentsMutationOptions = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type UpdateDocumentsMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateDocuments>>
>;
...
export const getReplaceDocumentsMutationOptions = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type ReplaceDocumentsMutationResult = NonNullable<
  Awaited<ReturnType<typeof replaceDocuments>>
>;
 ...
 * @summary Add or replace documents
 */
export const useReplaceDocuments = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getDeleteDocumentsByFilterMutationOptions = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DeleteDocumentsByFilterMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteDocumentsByFilter>>
>;
 ...
 * @summary Delete documents by filter
 */
export const useDeleteDocumentsByFilter = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
  ...
  return customInstance<SummarizedTaskView>(
    {
      ...
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      data: documentEditionByFunction,
      signal,
    },
    options,
  );
...
export const getEditDocumentsByFunctionMutationOptions = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type EditDocumentsByFunctionMutationResult = NonNullable<
  Awaited<ReturnType<typeof editDocumentsByFunction>>
>;
 ...
 * @summary Edit documents by function.
 */
export const useEditDocumentsByFunction = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const getDocumentsByQueryPostMutationOptions = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export type DocumentsByQueryPostMutationResult = NonNullable<
  Awaited<ReturnType<typeof documentsByQueryPost>>
>;
 ...
 * @summary Get documents with POST
 */
export const useDocumentsByQueryPost = <
  TError = ResponseError,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
...
export const useGetDocumentInfiniteQueryOptions = <
...
>(
  ...
  const queryKey =
    ...
    getGetDocumentQueryKey(indexUid, documentId, params);
...
export type GetDocumentInfiniteQueryResult = NonNullable<
  Awaited<ReturnType<typeof getDocument>>
>;
...
export function useGetDocumentInfinite<
  TData = Awaited<ReturnType<typeof getDocument>>,
  TError = ResponseError,
>(
  indexUid: string,
  ...
  const queryOptions = useGetDocumentInfiniteQueryOptions(
    indexUid,
    documentId,
    params,
    options,
...
export const useGetDocumentQueryOptions = <
  TData = Awaited<ReturnType<typeof getDocument>>,
  TError = ResponseError,
>(
  indexUid: string,
  ...
  const queryFn: QueryFunction<Awaited<ReturnType<typeof getDocument>>> = ({
    signal,
  }) => getDocument(indexUid, documentId, params, requestOptions, signal);
...
>(
  ...
  const queryOptions = useGetDocumentQueryOptions(
    indexUid,
    documentId,
    params,
    options,
